...
class SMTPChannel(asynchat.async_chat):
    ...
    def __init__(self, server, conn, addr, data_size_limit=DATA_SIZE_DEFAULT,
                 map=None, enable_SMTPUTF8=False, decode_data=False, require_authentication=False, credential_validator=None):
    ...
    def found_terminator(self):
        ...
        if self.smtp_state == self.COMMAND:
            ...
            args = (self.peer, self.mailfrom, self.rcpttos, self.received_data, self.authenticated_user)
            kwargs = {}
    ...
    def smtp_AUTH(self, arg):
        ...
        if 'LOGIN' == split_args[0].upper():
            ...
            try:
                ...
                self.push('501 invalid LOGIN encoding')
                self.authenticating = False
            #self.credential_validator = CredentialValidator(self.username.decode("utf-8"), self.password.decode("utf-8"))
...
class SMTPServer(asyncore.dispatcher):
    ...
    def __init__(self, localaddr, remoteaddr, require_authentication=False,
                 credentials=None,
        ...
        if require_authentication:
            self.credential_validator = CredentialValidator(credentials)
        else:
...
class CredentialValidator():
    ...
    def validate(self, username, password):
        ...
        for i in range(0, len(self.credentials), 2):
            if (username == self.credentials[i].strip('()')) and (password == self.credentials[i+1].strip('()')):
